    ...
    success: (res) => {
        ...
        if (res.success) {
            ...
            res.data.map((item) => {
                ...
                } else if (sjcz / 60 < 60 && sjcz / 60 >= 1) {  //分钟数
                    sjc.innerText = `${parseInt(sjcz / 60)}分钟之前`
                } else if (sjcz / 360 < 24 && sjcz / 60 >= 1) {
                    sjc.innerText = `${parseInt(sjcz / 360)}个小时之前`
                } else if (sjcz / 360 / 24 < 30) {
                    sjc.innerText = `${parseInt(sjcz / 360 / 24)}天之前`
                } else if (sjcz / 360 / 24 / 30 < 12) {
                    sjc.innerText = `${parseInt(sjcz / 360 / 24 / 30)}个月之前`
                } else if (sjcz / 360 / 24 / 30 / 12 >= 1) {
                    sjc.innerText = `${parseInt(sjcz / 360 / 24 / 30 / 12)}年之前`
                }
