        ...
        if (res.success) {
            ...
            res.data.map((item) => {
                ...
                if (sjcz < 60) {
                    ...
                    sjc.innerText = `${parseInt(sjcz / 3600)}个小时之前`
                } else if (sjcz / 3600 / 24 < 30) {
                    sjc.innerText = `${parseInt(sjcz / 3600 / 24)}天之前`
...
//跳转页面
let hq3dj = document.getElementsByClassName('hq-bt')[0];

    // 添加事件
    hq3dj.addEventListener('click', () => {
        window.open('1.html ? id = 601e668a03d797cf5b66f437', '_self')
