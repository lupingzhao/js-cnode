...
$.ajax({
    ...
    success: (res) => {
        ...
        if (res.success) {
            ...
            let fbsj = document.createElement('div')
            fbsj.classList.add('fbsj');

            let zzm = document.createElement('div')
            zzm.classList.add('zzm');

            let llan = document.createElement('div')
            llan.classList.add('llan');

            let ltime = document.createElement('div')
            ltime.classList.add('ltime');

            let fx = document.createElement('div')
            fx.classList.add('fx-wd');
