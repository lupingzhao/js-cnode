...
dlipts[2].addEventListener('blur', () => {
    ...
    if (dlipts[2].value === dlipts[1].value) {
        ...
        ts[2].innerHTML = ''
    } else if (dlipts[2].value === '' || dlipts[2].value !== dlipts[1].value) {
...
btns[0].addEventListener('click', () => {
    ...
    let tsy = ts.every(() => {
        console.log(ts[2].innerHTML);
        return ts.innerHTML === undefined
    })


    let srz = dlipts.every(() => {
        return dlipts.value !== undefined
